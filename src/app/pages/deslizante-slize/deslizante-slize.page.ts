...
@Component({
  selector: 'app-deslizante-slize',
  templateUrl: './deslizante-slize.page.html',
  styleUrls: ['./deslizante-slize.page.scss'],
})
export class DeslizanteSlizePage implements OnInit {
