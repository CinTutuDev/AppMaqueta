...
@Component({
  selector: 'app-deslizante-slide2',
  templateUrl: './deslizante-slide2.page.html',
  styleUrls: ['./deslizante-slide2.page.scss'],
})
export class DeslizanteSlide2Page implements OnInit {
